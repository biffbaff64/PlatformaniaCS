...
public class EntityData : IDisposable
{
    ...
    // ==========================================================
    static readonly ReadOnlyCollection<SpriteDescriptor> EntityList = new ReadOnlyCollection<SpriteDescriptor>
        ( new[]
        {
            // -----------------------------------------------------
            // Player
            ...
            {
                Name     = "Crate",
                GID      = GraphicID.G_CRATE, Type = GraphicID._INTERACTIVE,
