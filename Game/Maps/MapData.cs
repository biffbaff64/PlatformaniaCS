...
namespace PlatformaniaCS.Game.Maps
{
    public class MapData : IDisposable
    {
        ...
        public Box< float > ViewportBox         { get; set; }
        public Box< float > EntityWindow        { get; set; }
        ...
        public MapData()
        {
            ...
            ViewportBox         = new Box< float >();
            EntityWindow        = new Box< float >();
        ...
        public void PositionAt( int x, int y )
        {
            ...
            xPosition -= ( Gfx.ViewWidth / 2f );
            yPosition -= ( Gfx.ViewHeight / 2f );
